...
class GSSimpleDataset(Dataset):
    def __init__(self, args, max_interval=None):
        ...
        self.img_dir = os.path.join(self.seq_dir, self.seq_name, "images")
        ...
        self.images = np.stack(self.images)  # [num_imgs, h, w, 3]
    ...
    def __getitem__(self, idx):
        ...
        pair_weight = np.cos((frame_interval - 1.) / self.max_interval.value * np.pi / 2)
        weights = pair_weight
